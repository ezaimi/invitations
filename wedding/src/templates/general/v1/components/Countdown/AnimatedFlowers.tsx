...
function AnimatedFlowers() {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      ...
      },
      {
        ...
        x: 0,
        y: 0,
        duration: 2.2, // slower → smoother
        ease: "power4.out", // softer curve
        stagger: 0.05, // very subtle delay
      }
    )
  }, [])
  ...
  return (
    <div ref={container}>
      ...
      <div ref={flower2} className="absolute right-1/3 -mt-4 z-20">
        <Image
      ...
      <div ref={flower3} className="absolute left-1/2 -translate-x-[calc(25%-30px)] z-10 -mt-5">
        <Image
